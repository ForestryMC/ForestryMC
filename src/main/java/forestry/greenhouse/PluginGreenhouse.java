...
public class PluginGreenhouse extends BlankForestryPlugin {
	...
	public void registerRecipes() {
		...
		RecipeUtil.addRecipe(items.camouflageSprayCan, "TTT", "TCT", "TCT", 'T', OreDictUtil.INGOT_TIN, 'C', coreItems.craftingMaterial.getCamouflagedPaneling());

		ItemStack greenhousePlainBlock = new ItemStack(blocks.greenhouseBlock, 2, BlockGreenhouseType.PLAIN.ordinal());
		RecipeUtil.addRecipe(greenhousePlainBlock.copy(),
			"#X#",
			"SIS",
		...
		RecipeUtil.addRecipe(new ItemStack(blocks.greenhouseBlock, 1, BlockGreenhouseType.CONTROL.ordinal()),
			" X ",
			"#T#",
		...
		RecipeUtil.addRecipe(new ItemStack(blocks.greenhouseBlock, 1, BlockGreenhouseType.GEARBOX.ordinal()),
			" X ",
			"###",
			'X', greenhousePlainBlock.copy(),
			'#', OreDictUtil.GEAR_TIN);

		RecipeUtil.addRecipe(new ItemStack(blocks.climatiserBlock, 1, BlockClimatiserType.HYGRO.ordinal()),
			"GIG",
			"GXG",
			"GIG",
			'X', greenhousePlainBlock.copy(),
		...
		RecipeUtil.addRecipe(new ItemStack(blocks.climatiserBlock, 1, BlockClimatiserType.HEATER.ordinal()),
			"T#T",
			"#X#",
			"T#T",
			'X', greenhousePlainBlock.copy(),
		...
		RecipeUtil.addRecipe(new ItemStack(blocks.climatiserBlock, 1, BlockClimatiserType.FAN.ordinal()),
			"T#T",
			"#X#",
			"T#T",
			'X', greenhousePlainBlock.copy(),
		...
		RecipeUtil.addRecipe(new ItemStack(blocks.climatiserBlock, 1, BlockClimatiserType.DEHUMIDIFIER.ordinal()),
			"T#T",
			"#X#",
			"T#T",
			'X', greenhousePlainBlock.copy(),
		...
		RecipeUtil.addRecipe(new ItemStack(blocks.climatiserBlock, 1, BlockClimatiserType.HUMIDIFIER.ordinal()),
			"T#T",
			"#X#",
			"T#T",
			'X', greenhousePlainBlock.copy(),
		...
		for (String glassName : GreenhouseManager.greenhouseHelper.getWindowGlasses()) {
			...
			RecipeUtil.addRecipe(roodWindow,
				true,
				"SGS",
				"GGG",
				"GGG",
