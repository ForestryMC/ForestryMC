...
public class PacketCamouflageUpdateToServer extends PacketCoordinates implements IForestryPacketServer {

	private ItemStack camouflageBlock;
	private EnumCamouflageType type;
	private boolean isMultiblock;

	public PacketCamouflageUpdateToServer() {
	}

	public PacketCamouflageUpdateToServer(ICamouflageHandler tile, EnumCamouflageType type, boolean isMultiblock) {
	...
	public PacketCamouflageUpdateToServer(ICamouflageHandler tile, EnumCamouflageType type) {
		super(tile.getCoordinates());
		this.camouflageBlock = tile.getCamouflageBlock(type);
