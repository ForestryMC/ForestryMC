...
public class MachineSqueezer extends TilePowered
		implements ISocketable, ISidedInventory, ILiquidTankContainer, ISpeedUpgradable {
	...
	public void openGui(EntityPlayer player) {
		player.openGui(ForestryAPI.instance, GuiId.SqueezerGUI.ordinal(), player.worldObj, pos.getX(), pos.getY(),
				pos.getZ());
	}
