...
public class RainmakerRecipeWrapper implements IRecipeCategoryExtension {
	...
	public void drawInfo(int recipeWidth, int recipeHeight, MatrixStack matrixStack, double mouseX, double mouseY) {
		...
		fontRenderer.func_243248_b(matrixStack, new TranslationTextComponent("for.jei.rainmaker.speed", substrate.getSpeed()), 24, 10, Color.gray.getRGB());
		if (!substrate.isReverse()) {
			fontRenderer.func_243248_b(matrixStack, new TranslationTextComponent("for.jei.rainmaker.duration", substrate.getDuration()), 24, 20, Color.gray.getRGB());
		}
	}
