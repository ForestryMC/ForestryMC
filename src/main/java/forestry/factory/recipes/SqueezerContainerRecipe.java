...
public class SqueezerContainerRecipe implements ISqueezerContainerRecipe {
    ...
    public SqueezerContainerRecipe(
            ItemStack emptyContainer, int processingTime, ItemStack remnants, float remnantsChance) {
    ...
    public ISqueezerRecipe getSqueezerRecipe(ItemStack filledContainer) {
        ...
        return new SqueezerRecipe(
                processingTime, new ItemStack[] {filledContainerCopy}, fluidOutput, remnants, remnantsChance);
    }
}
