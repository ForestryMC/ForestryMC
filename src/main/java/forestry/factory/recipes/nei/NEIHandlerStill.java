	...
	public class CachedStillRecipe extends CachedBaseRecipe {
		...
		public CachedStillRecipe(MachineStill.Recipe recipe) {
			if (recipe.input != null) {
				this.tanks.add(new PositionedFluidTank(recipe.input, 10000, new Rectangle(30, 4, 16, 58),
						NEIHandlerStill.this.getGuiTexture(), new Point(176, 0)));
			}
			if (recipe.output != null) {
				this.tanks.add(new PositionedFluidTank(recipe.output, 10000, new Rectangle(120, 4, 16, 58),
						NEIHandlerStill.this.getGuiTexture(), new Point(176, 0)));
			}
		}
