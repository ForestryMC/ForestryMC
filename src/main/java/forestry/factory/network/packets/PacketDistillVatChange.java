...
public class PacketDistillVatChange extends PacketCoordinates implements IForestryPacketClient {

	public PacketDistillVatChange() {
	}

	public PacketDistillVatChange(IDistillVatControllerInternal controller) {
