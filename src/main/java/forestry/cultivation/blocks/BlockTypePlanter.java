...
public enum BlockTypePlanter implements IBlockTypeCustom {
	ARBORETUM(() -> CultivationTiles.ARBORETUM, "arboretum"), FARM_CROPS(() -> CultivationTiles.CROPS, "farm_crops"), FARM_MUSHROOM(() -> CultivationTiles.MUSHROOM, "farm_mushroom"), FARM_GOURD(() -> CultivationTiles.GOURD, "farm_gourd"), FARM_NETHER(() -> CultivationTiles.NETHER, "farm_nether"), FARM_ENDER(() -> CultivationTiles.ENDER, "farm_ender"), PEAT_POG(() -> CultivationTiles.BOG, "peat_bog"),
