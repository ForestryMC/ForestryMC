...
public class TileBog extends TilePlanter {
	...
	public NonNullList<ItemStack> createResourceStacks() {
		return createList(CoreBlocks.BOG_EARTH.stack(), CoreBlocks.BOG_EARTH.stack(), CoreBlocks.BOG_EARTH.stack(), CoreBlocks.BOG_EARTH.stack());
	}

	@Override
	public NonNullList<ItemStack> createProductionStacks() {
		return createList(CoreItems.PEAT.stack(), CoreItems.PEAT.stack(), CoreItems.PEAT.stack(), CoreItems.PEAT.stack());
	}
}
