...
public abstract class EntityUtil {
    public static <E extends EntityLiving> E spawnEntity(
            World world, Class<E> entityClass, double x, double y, double z) {
    ...
    public static void registerEntity(
        ...
        EntityRegistry.registerModEntity(
                entityClass, ident, id, ForestryAPI.instance, trackingRange, updateFrequency, sendVelocity);
    ...
    public static <T extends Entity> List<T> getEntitiesWithinAABB(
            World world, Class<T> entityClass, AxisAlignedBB boundingBox) {
        return world.getEntitiesWithinAABB(entityClass, boundingBox);
    }

    @SuppressWarnings("unchecked")
    public static <T extends Entity> List<T> selectEntitiesWithinAABB(
            World world, EntitySelector<T> entitySelector, AxisAlignedBB boundingBox) {
