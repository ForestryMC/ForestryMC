...
public abstract class Utils {
	...
	public static boolean isReplaceableBlock(Block block) {
		return block == Blocks.vine || block == Blocks.tallgrass || block == Blocks.deadbush
				|| block == Blocks.snow_layer || block.getMaterial().isReplaceable();
	}
	...
	public static void registerEntity(Class<? extends Entity> entityClass, String ident, int id, int eggForeground,
		...
		EntityRegistry.registerModEntity(entityClass, ident, id, ForestryAPI.instance, trackingRange, updateFrequency,
				sendVelocity);
	...
	public static <T extends TileEntity> T getTile(IBlockAccess world, BlockPos pos, Class<T> tileClass) {
		...
		if (tileClass.isInstance(tileEntity)) {
			...
			Proxies.log.warning("Failed to cast a tile entity {" + tileEntity + "} to a {" + tileClass.getName()
