...
public class CoreItems {
	...
	public static final FeatureItem<ItemForestryTool> BRONZE_PICKAXE = REGISTRY.item(() -> new ItemForestryTool(BROKEN_BRONZE_PICKAXE.stack(), 2, -2.7, (new Item.Properties()).addToolType(ToolType.PICKAXE, 3).durability(200).tab(ItemGroupForestry.tabForestry)), "bronze_pickaxe");
	public static final FeatureItem<ItemForestryTool> BRONZE_SHOVEL = REGISTRY.item(() -> new ItemForestryTool(BROKEN_BRONZE_SHOVEL.stack(), 3, -3, (new Item.Properties()).addToolType(ToolType.SHOVEL, 3).durability(200).tab(ItemGroupForestry.tabForestry)), "bronze_shovel");
