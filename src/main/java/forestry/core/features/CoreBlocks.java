...
public class CoreBlocks {
	...
	public static final FeatureBlockGroup<BlockCore, BlockTypeCoreTesr> BASE = REGISTRY.blockGroup(BlockCore::new, BlockTypeCoreTesr.VALUES).setItem(ItemBlockBase::new).create();
	...
	public static final FeatureBlockGroup<BlockResourceStorage, EnumResourceType> RESOURCE_STORAGE = REGISTRY.blockGroup(BlockResourceStorage::new, EnumResourceType.VALUES).setItem((Function<BlockResourceStorage, BlockItem>) ItemBlockForestry::new).setIdent("resource_storage").create();
	public static final FeatureBlockGroup<BlockResourceOre, EnumResourceType> RESOURCE_ORE = REGISTRY.blockGroup(BlockResourceOre::new, EnumResourceType.VALUES).setItem((Function<BlockResourceOre, BlockItem>) ItemBlockForestry::new).setIdent("resource_ore").create();
