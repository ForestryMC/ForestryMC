...
////		sender.sendMessage(new TranslationTextComponent(locTag, args));
//	}
//
...
//	}
//
//	public static void throwWrongUsage(CommandSource sender, IForestryCommand command) {//throws WrongUsageException {
////		throw new WrongUsageException(Translator.translateToLocalFormatted("for.chat.help", command.getUsage(sender)));
//	}
//
//	public static void processChildCommand(MinecraftServer server, CommandSource sender, SubCommand child, String[] args) throws CommandException {
...
//	}
//
//	public static void printHelp(CommandSource sender, IForestryCommand command) {
//
...
//	}
//
//	public static boolean processStandardCommands(MinecraftServer server, CommandSource sender, IForestryCommand command, String[] args) throws CommandException {
////		if (args.length >= 1) {
...
//
//	public static List<String> addStandardTabCompletionOptions(MinecraftServer server, IForestryCommand command, CommandSource sender, String[] incomplete, @Nullable BlockPos pos) {
