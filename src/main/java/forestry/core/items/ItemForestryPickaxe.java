...
public class ItemForestryPickaxe extends ItemForestryTool {
	...
	static {
		blocksEffectiveAgainst = (new Block[] { Blocks.cobblestone, Blocks.stone, Blocks.sandstone,
				Blocks.mossy_cobblestone, Blocks.iron_ore, Blocks.iron_block, Blocks.coal_ore, Blocks.gold_block,
				Blocks.brick_block, Blocks.nether_brick, Blocks.netherrack, Blocks.gold_ore, Blocks.diamond_ore,
				Blocks.diamond_block, Blocks.ice, Blocks.netherrack, Blocks.lapis_ore, Blocks.lapis_block,
				ForestryBlock.resources.block(), ForestryBlock.beehives.block(), ForestryBlock.engine.block(),
				ForestryBlock.factoryTESR.block(), ForestryBlock.factoryPlain.block() });
	}
