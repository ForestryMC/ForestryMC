...
public final class ForestryBlockTagsProvider extends BlockTagsProvider {
	...
	protected void registerTags() {
		...
		getBuilder(ForestryTags.Blocks.ORE_COPPER).add(CoreBlocks.RESOURCE_ORE.get(EnumResourceType.COPPER).getBlock());
		getBuilder(ForestryTags.Blocks.ORE_TIN).add(CoreBlocks.RESOURCE_ORE.get(EnumResourceType.TIN).getBlock());
		getBuilder(ForestryTags.Blocks.ORE_APATITE).add(CoreBlocks.RESOURCE_ORE.get(EnumResourceType.APATITE).getBlock());
		...
		getBuilder(ForestryTags.Blocks.STORAGE_BLOCK_COPPER).add(CoreBlocks.RESOURCE_STORAGE.get(EnumResourceType.COPPER).getBlock());
		getBuilder(ForestryTags.Blocks.STORAGE_BLOCK_TIN).add(CoreBlocks.RESOURCE_STORAGE.get(EnumResourceType.TIN).getBlock());
		getBuilder(ForestryTags.Blocks.STORAGE_BLOCK_BRONZE).add(CoreBlocks.RESOURCE_STORAGE.get(EnumResourceType.BRONZE).getBlock());
		getBuilder(ForestryTags.Blocks.STORAGE_BLOCK_APATITE).add(CoreBlocks.RESOURCE_STORAGE.get(EnumResourceType.APATITE).getBlock());
	}
