...
public interface IFilterSlotDelegate {
    ...
    /**
     * Non-automation version of IInventory's isItemValidForSlot. Used to determine if a player can place a stack in a
     * slot.
     *
    ...
    /**
     * Used to lock slots under special conditions. Locked slots will have an X over them.
     */
