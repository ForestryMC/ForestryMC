...
public class ParticleHelper {
    ...
    public static boolean addHitEffects(
            World world, Block block, MovingObjectPosition target, EffectRenderer effectRenderer, Callback callback) {
        int x = target.blockX;
        int y = target.blockY;
        int z = target.blockZ;
    ...
    public static boolean addDestroyEffects(
            World world, Block block, int x, int y, int z, int meta, EffectRenderer effectRenderer, Callback callback) {
        if (block != world.getBlock(x, y, z)) {
            return true;
        }
