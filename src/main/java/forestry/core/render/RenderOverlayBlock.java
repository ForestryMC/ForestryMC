...
public abstract class RenderOverlayBlock implements ISimpleBlockRenderingHandler {
    ...
    private static int determineMixedBrightness(
            IBlockAccess world, Block block, int x, int y, int z, RenderBlocks renderer, int mixedBrightness) {
        return renderer.renderMinY > 0.0D ? mixedBrightness : block.getMixedBrightnessForBlock(world, x, y, z);
    }

    protected static void renderBottomFace(
            IBlockAccess world,
            Block block,
            int x,
            int y,
    ...
    protected static void renderTopFace(
            IBlockAccess world,
            Block block,
            int x,
            int y,
    ...
    protected static void renderEastFace(
            IBlockAccess world,
            Block block,
            int x,
            int y,
    ...
    protected static void renderWestFace(
            IBlockAccess world,
            Block block,
            int x,
            int y,
    ...
    protected static void renderNorthFace(
            IBlockAccess world,
            Block block,
            int x,
            int y,
    ...
    protected static void renderSouthFace(
            IBlockAccess world,
            Block block,
            int x,
            int y,
