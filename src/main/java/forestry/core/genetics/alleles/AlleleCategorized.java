...
/**
 * Alleles that have a category with several values inherit from this class. For
 * example, temperature tolerances or speeds are categories with several values.
 *
 * This class helps localization by allowing specific names like
 * forestry.allele.speed.fast and can fall back on generic names like
