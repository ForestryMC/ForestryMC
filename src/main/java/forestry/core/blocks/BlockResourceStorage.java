...
public class BlockResourceStorage extends Block {
	...
	public void registerBlockIcons(IIconRegister register) {
		ResourceType.APATITE.icon = TextureManager.getSprite(register, "storage/apatite");
		ResourceType.COPPER.icon = TextureManager.getSprite(register, "storage/copper");
		ResourceType.TIN.icon = TextureManager.getSprite(register, "storage/tin");
		ResourceType.BRONZE.icon = TextureManager.getSprite(register, "storage/bronze");
	}
