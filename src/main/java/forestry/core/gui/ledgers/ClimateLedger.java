...
public class ClimateLedger extends Ledger {
	...
	public ITextComponent getTooltip() {
		return new StringTextComponent("T: ").append(AlleleManager.climateHelper.toDisplay(tile.getTemperature())).append(new StringTextComponent(" / H: ")).append(AlleleManager.climateHelper.toDisplay(tile.getHumidity()));
	}
}
