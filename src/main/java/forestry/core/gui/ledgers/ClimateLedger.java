...
public class ClimateLedger extends Ledger {
	...
	public void draw(int x, int y) {
		...
		drawText(AlleleManager.climateHelper.toDisplay(temperature) + ' '
				+ StringUtil.floatAsPercent(tile.getExactTemperature()), x + 22, y + 32);

		drawSubheader(StringUtil.localize("gui.humidity") + ':', x + 22, y + 44);
		drawText(AlleleManager.climateHelper.toDisplay(tile.getHumidity()) + ' '
				+ StringUtil.floatAsPercent(tile.getExactHumidity()), x + 22, y + 56);
	}
