...
public class GuiConstants {
    ...
    public static final Style BLACK_STYLE = DEFAULT_STYLE.setColor(Color.fromInt(0x000000));
    public static final Style GRAY_STYLE = DEFAULT_STYLE.setColor(Color.fromInt(0x666666));
