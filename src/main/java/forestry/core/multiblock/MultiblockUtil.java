...
public class MultiblockUtil {
    ...
    /**
     * Returns an array containing references to neighboring IMultiblockComponent tile entities. Primarily a utility
     * method. Only works after tileentity construction.
     *
     * This method is chunk-safe on the server; it will not query for parts in chunks that are unloaded. Note that no
     * method is chunk-safe on the client, because ChunkProviderClient is stupid.
     * 
