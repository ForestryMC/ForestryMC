...
/**
 * This is a very static singleton registry class which directs incoming events to sub-objects, which actually manage
 * each individual world's multiblocks.
 * 
...
public class MultiblockRegistry {
    ...
    /**
     * Call to mark a controller as dead. It should only be marked as dead when it has no connected parts. It will be
     * removed after the next world tick.
     * 
