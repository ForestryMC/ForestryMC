...
public interface IMultiblockSizeLimits {
    ...
    /**
     * Helper method so we don't check for a whole machine until we have enough blocks to actually assemble it. This
     * isn't as simple as xmax*ymax*zmax for non-cubic machines or for machines with hollow/complex interiors.
     * 
    ...
    /**
     * Returns the maximum X dimension size of the machine, or -1 (DIMENSION_UNBOUNDED) to disable dimension checking in
     * X. (This is not recommended.)
     * 
    ...
    /**
     * Returns the maximum Z dimension size of the machine, or -1 (DIMENSION_UNBOUNDED) to disable dimension checking in
     * X. (This is not recommended.)
     * 
    ...
    /**
     * Returns the maximum Y dimension size of the machine, or -1 (DIMENSION_UNBOUNDED) to disable dimension checking in
     * X. (This is not recommended.)
     * 
