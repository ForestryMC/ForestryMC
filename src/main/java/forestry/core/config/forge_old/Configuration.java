...
package forestry.core.config.forge_old;
...
public class Configuration {
    ...
    public void load() {
        ...
        try {
            ...
            LogManager.getLogger().error("Error while loading config {}.", fileName, e);
        } finally {
    ...
    public void save() {
        ...
        try {
            ...
            LogManager.getLogger().error("Error while saving config {}.", fileName, e);
        }
    }
