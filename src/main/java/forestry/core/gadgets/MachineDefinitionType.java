...
public enum MachineDefinitionType implements IStringSerializable {

	ESCRITOIRE(Defaults.DEFINITION_CORE_ID, Defaults.DEFINITION_ANALYZER_META),
	...
	CHEST_APICULTURE(Defaults.DEFINITION_APICULTURE_ID, Defaults.DEFINITION_APIARISTCHEST_META),
	...
	private MachineDefinitionType(int definitionID, String name, int meta) {
		this.meta = meta;
		this.name = name;
		this.definitionID = definitionID;
	}
	
	private MachineDefinitionType(int definitionID, int meta) {
		this.meta = meta;
		this.definitionID = definitionID;
	}
	...
	public static MachineDefinitionType getType(int definitionID, int meta)
	{
		for(MachineDefinitionType type : values())
		{
