...
public class ModelEscritoire extends Model {
	...
	public ModelEscritoire() {
		...
		standLowLF = new RendererModel(this, 0, 26);
		...
		standLowRB = new RendererModel(this, 0, 26);
		...
		standLowRF = new RendererModel(this, 0, 26);
		...
		standLowLB = new RendererModel(this, 0, 26);
