...
public class EnergyManager implements IEnergyHandler, IStreamable {
	...
	public EnergyManager(int maxTransfer, int capacity) {
		this.energyStorage = new EnergyStorage(scaleForDifficulty(capacity), scaleForDifficulty(maxTransfer),
	...
	/**
	 * Sends as much energy as it can to the tile at orientation. For power
	 * sources. Ignores canExtract()
	 *
	 * @return amount sent
	 */
	...
	/**
	 * Sends amount of energy to the tile at orientation. For power sources.
	 * Ignores canExtract()
	 *
	 * @return amount sent
	 */
	...
	/**
	 * Drains an amount of energy, due to decay from lack of work or other
	 * factors
	 */
