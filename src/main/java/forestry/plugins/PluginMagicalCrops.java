...
public class PluginMagicalCrops extends ForestryPlugin {
	...
	protected void postInit() {
		...
		ImmutableList<String> magicSeeds = ImmutableList.of("Essence", "Coal", "Dye", "Redstone", "Glowstone",
				"Obsidian", "Iron", "Gold", "Lapis", "Ender", "Nether", "Experience", "Blaze", "Diamond", "Emerald");

		ImmutableList<String> elementSeeds = ImmutableList.of("Air", "Water", "Earth", "Fire");

		ImmutableList<String> modMagicSeeds = ImmutableList.of("Copper", "Tin", "Silver", "Lead", "Quartz", "Sapphire",
				"Ruby", "Peridot", "Aluminium", "Force", "Cobalt", "Ardite", "Nickel", "Platinum", "ThaumcraftShard",
				"Uranium", "Oil", "Rubber", "Vinteum", "BlueTopaz", "Chimerite", "Moonstone", "Sunstone", "Iridium",
				"Yellorite", "Osmium", "Manganese", "Sulfur", "Darkiron");

		ImmutableList<String> soulSeeds = ImmutableList.of("Cow", "Creeper", "Magma", "Skeleton", "Slime", "Spider",
				"Ghast", "Wither");

		ImmutableList<String> potionSeeds = ImmutableList.of("Fire", "Water", "Strength", "Regen", "Night", "Speed");

		ImmutableList<String> seeds = ImmutableList.of("Blackberry", "Blueberry", "Chili", "Cucumber", "Grape",
				"Raspberry", "Strawberry", "Sweetcorn", "Tomato", "SugarCane");

		ImmutableList<String> betaSeeds = ImmutableList.of("Air", "Aluminium", "Alumite", "Ardite", "Blaze", "Blizz",
				"Bronze", "CertusQuartz", "Chicken", "Coal", "Cobalt", "Copper", "Cow", "Creeper", "Diamond", "Dye",
				"Earth", "Electrum", "Emerald", "Enderium", "Enderman", "Experience", "Fire", "Fluix", "Ghast",
				"Glowstone", "Gold", "Invar", "Iron", "Lapis", "Lead", "Lumium", "Manasteel", "Manyullyn", "Minicio",
				"Nature", "Nether", "Nickel", "Obsidian", "Osmium", "Peridot", "Pig", "Platinum", "Quartz", "Redstone",
				"Rubber", "Ruby", "Saltpeter", "Sapphire", "Sheep", "Signalum", "Silver", "Skeleton", "Slime", "Spider",
				"Steel", "Sulfur", "Terrasteel", "Tin", "Water", "Wither", "Yellorite");
		...
		if (cropProduce != null) {
			...
			ItemStack produce = new ItemStack(GameRegistry.findItem(MagCrop, MagCrop + "_CropProduce"), 1,
					Defaults.WILDCARD);
			RecipeUtil.injectLeveledRecipe(produce, GameMode.getGameMode().getIntegerSetting("fermenter.yield.wheat"),
					Fluids.BIOMASS);
			RecipeManagers.squeezerManager.addRecipe(10, new ItemStack[] { produce },
	...
	private static void addRecipes(String seedPrefix, String cropPrefix, String name, int fluidAmount) {
		...
		if (seed != null) {
			RecipeManagers.squeezerManager.addRecipe(10, new ItemStack[] { seed },
					Fluids.SEEDOIL.getFluid(fluidAmount));
		}
