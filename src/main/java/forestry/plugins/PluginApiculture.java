...
import forestry.apiculture.FlowerProviderGeneric;
...
public class PluginApiculture extends ForestryPlugin {
	...
	private void createAlleles() {
		...
		Allele.flowersVanilla = new AlleleFlowers("flowersVanilla", new FlowerProviderGeneric(FlowerManager.FlowerTypeVanilla, "flowers.vanilla"), true);
		Allele.flowersNether = new AlleleFlowers("flowersNether", new FlowerProviderGeneric(FlowerManager.FlowerTypeNether, "flowers.nether"));
		Allele.flowersCacti = new AlleleFlowers("flowersCacti", new FlowerProviderGeneric(FlowerManager.FlowerTypeCacti, "flowers.cacti"));
		Allele.flowersMushrooms = new AlleleFlowers("flowersMushrooms", new FlowerProviderGeneric(FlowerManager.FlowerTypeMushrooms, "flowers.mushroom"));
		Allele.flowersEnd = new AlleleFlowers("flowersEnd", new FlowerProviderGeneric(FlowerManager.FlowerTypeEnd, "flowers.end"));
		Allele.flowersJungle = new AlleleFlowers("flowersJungle", new FlowerProviderGeneric(FlowerManager.FlowerTypeJungle, "flowers.jungle"));
		Allele.flowersSnow = new AlleleFlowers("flowersSnow", new FlowerProviderGeneric(FlowerManager.FlowerTypeSnow, "flowers.vanilla"), true);
		Allele.flowersWheat = new AlleleFlowers("flowersWheat", new FlowerProviderGeneric(FlowerManager.FlowerTypeWheat, "flowers.wheat"), true);
		Allele.flowersGourd = new AlleleFlowers("flowersGourd", new FlowerProviderGeneric(FlowerManager.FlowerTypeGourd, "flowers.gourd"), true);
