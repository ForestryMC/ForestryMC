...
public class PluginApiculture extends ForestryPlugin {
	...
	public void preInit() {
		...
		ForestryBlock.apiculture.registerBlock(new BlockBase(Material.iron, Defaults.DEFINITION_APICULTURE_ID), ItemForestryBlock.class, "apiculture");
	...
	@Override
	public void populateChunk(IChunkProvider chunkProvider, World world, Random rand, BlockPos pos, boolean hasVillageGenerated) {
