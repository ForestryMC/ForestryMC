...
@Plugin(
        ...
        author = "SirSengir",
        url = Constants.URL,
        unlocalizedDescription = "for.plugin.energy.description")
public class PluginEnergy extends ForestryPlugin {

    @SidedProxy(
            clientSide = "forestry.energy.proxy.ProxyEnergyClient",
            serverSide = "forestry.energy.proxy.ProxyEnergy")
    ...
    protected void registerRecipes() {
        ...
        RecipeUtil.addRecipe(
                blocks.engine.get(BlockEngineType.PEAT),
                "###",
                " X ",
                "YVY",
                '#',
        ...
        RecipeUtil.addRecipe(
                blocks.engine.get(BlockEngineType.BIOGAS),
                "###",
                " X ",
                "YVY",
                '#',
        ...
        if (ForestryAPI.activeMode.getBooleanSetting("energy.engine.clockwork")) {
            RecipeUtil.addRecipe(
                    blocks.engine.get(BlockEngineType.CLOCKWORK),
                    "###",
                    " X ",
                    "ZVY",
                    '#',
