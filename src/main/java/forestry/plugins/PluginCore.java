...
public class PluginCore extends ForestryPlugin {
	...
	protected void registerCrates() {
		ForestryCrate.registerCrate(Blocks.log, "cratedWood");
		ForestryCrate.registerCrate(Blocks.cobblestone, "cratedCobblestone");
		ForestryCrate.registerCrate(Blocks.dirt, "cratedDirt");
		ForestryCrate.registerCrate(Blocks.stone, "cratedStone");
		ForestryCrate.registerCrate(Blocks.brick_block, "cratedBrick");
		ForestryCrate.registerCrate(Blocks.cactus, "cratedCacti");
		ForestryCrate.registerCrate(Blocks.sand, "cratedSand");
		ForestryCrate.registerCrate(Blocks.obsidian, "cratedObsidian");
		ForestryCrate.registerCrate(Blocks.netherrack, "cratedNetherrack");
		ForestryCrate.registerCrate(Blocks.soul_sand, "cratedSoulsand");
		ForestryCrate.registerCrate(Blocks.sandstone, "cratedSandstone");
		ForestryCrate.registerCrate(ForestryBlock.soil.getItemStack(1, 0), "cratedHumus");
		ForestryCrate.registerCrate(ForestryBlock.soil.getItemStack(1, 1), "cratedBogearth");
		ForestryCrate.registerCrate(Blocks.nether_brick, "cratedNetherbrick");
		ForestryCrate.registerCrate(ForestryItem.peat.item(), "cratedPeat");
		ForestryCrate.registerCrate(ForestryItem.apatite.item(), "cratedApatite");
		ForestryCrate.registerCrate(ForestryItem.fertilizerCompound.item(), "cratedFertilizer");
		ForestryCrate.registerCrate(ForestryItem.ingotTin.item(), "cratedTin").setUsesOreDict(true);
		ForestryCrate.registerCrate(ForestryItem.ingotCopper.item(), "cratedCopper").setUsesOreDict(true);
		ForestryCrate.registerCrate(ForestryItem.ingotBronze.item(), "cratedBronze").setUsesOreDict(true);
		ForestryCrate.registerCrate(Items.wheat, "cratedWheat");
		ForestryCrate.registerCrate(Blocks.mycelium, "cratedMycelium");
		ForestryCrate.registerCrate(ForestryItem.mulch.item(), "cratedMulch");
		ForestryCrate.registerCrate(Items.cookie, "cratedCookies");
		ForestryCrate.registerCrate(Items.redstone, "cratedRedstone");
		ForestryCrate.registerCrate(new ItemStack(Items.dye, 1, 4), "cratedLapis");
		ForestryCrate.registerCrate(Items.reeds, "cratedReeds");
		ForestryCrate.registerCrate(Items.clay_ball, "cratedClay");
		ForestryCrate.registerCrate(Items.glowstone_dust, "cratedGlowstone");
		ForestryCrate.registerCrate(Items.apple, "cratedApples");
		ForestryCrate.registerCrate(new ItemStack(Items.nether_wart), "cratedNetherwart");
		ForestryCrate.registerCrate(ForestryItem.phosphor.item(), "cratedPhosphor");
		ForestryCrate.registerCrate(ForestryItem.ash.item(), "cratedAsh");
		ForestryCrate.registerCrate(new ItemStack(Items.coal, 1, 1), "cratedCharcoal");
		ForestryCrate.registerCrate(new ItemStack(Items.coal, 1, 0), "cratedCoal");
