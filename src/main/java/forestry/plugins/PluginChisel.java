...
public class PluginChisel extends ForestryPlugin {
	...
	protected void registerRecipes() {
		...
		ImmutableList<String> worldgenBlocks = ImmutableList.of("granite", "limestone", "marble", "andesite",
				"diorite");
		for (String wBlocks : worldgenBlocks) {
			FMLInterModComms.sendMessage(Defaults.MOD, "add-backpack-items",
					String.format("digger@%s:%s", Chisel, wBlocks));
		}
