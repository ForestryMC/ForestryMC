...
final class Flower implements IFlower {
	...
	public boolean equals(Object obj) {
		...
		return Block.isEqualTo(this.block, flower.getBlock()) && (this.meta == OreDictionary.WILDCARD_VALUE
				|| flower.getMeta() == OreDictionary.WILDCARD_VALUE || this.meta == flower.getMeta());
	}
