...
public class ModuleInventoryApiary implements IBeeHousingInventory {

	private static IModuleInventory inventory;
	
	public ModuleInventoryApiary(IModuleInventory inventory) {
		ModuleInventoryApiary.inventory = inventory;
	}
