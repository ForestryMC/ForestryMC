...
public class EntityBeeFX extends EntityFX {
	...
	public void renderParticle(WorldRenderer worldRenderer, Entity entity, float f, float f1, float f2, float f3,
		...
		worldRenderer.addVertexWithUV((f11 - f1 * f10) + f4 * f10, f12 + f2 * f10, (f13 - f3 * f10) + f5 * f10, maxU,
				minV);
		worldRenderer.addVertexWithUV(f11 + f1 * f10 + f4 * f10, f12 + f2 * f10, f13 + f3 * f10 + f5 * f10, minU, minV);
		worldRenderer.addVertexWithUV((f11 + f1 * f10) - f4 * f10, f12 - f2 * f10, (f13 + f3 * f10) - f5 * f10, minU,
				maxV);
	}
