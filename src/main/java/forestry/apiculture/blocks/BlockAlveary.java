...
public class BlockAlveary extends BlockStructure {
	...
	public void registerBlockIcons(IIconRegister register) {
		icons = new IIcon[14];
		icons[0] = TextureManager.getSprite(register, "apiculture/alveary.plain");
		icons[1] = TextureManager.getSprite(register, "apiculture/alveary.entrance");
		icons[2] = TextureManager.getSprite(register, "apiculture/alveary.bottom");
		icons[3] = TextureManager.getSprite(register, "apiculture/alveary.left");
		icons[4] = TextureManager.getSprite(register, "apiculture/alveary.right");
		icons[5] = TextureManager.getSprite(register, "apiculture/alveary.swarmer.off");
		icons[6] = TextureManager.getSprite(register, "apiculture/alveary.swarmer.on");
		icons[7] = TextureManager.getSprite(register, "apiculture/alveary.heater.off");
		icons[8] = TextureManager.getSprite(register, "apiculture/alveary.heater.on");
		icons[9] = TextureManager.getSprite(register, "apiculture/alveary.fan.off");
		icons[10] = TextureManager.getSprite(register, "apiculture/alveary.fan.on");
		icons[11] = TextureManager.getSprite(register, "apiculture/alveary.valve");
		icons[12] = TextureManager.getSprite(register, "apiculture/alveary.stabiliser");
		icons[13] = TextureManager.getSprite(register, "apiculture/alveary.sieve");
	}
