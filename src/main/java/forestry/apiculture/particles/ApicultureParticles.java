...
public class ApicultureParticles {
	...
	public static void registerParticleFactory(ParticleFactoryRegisterEvent event) {
		Minecraft.getInstance().particles.registerFactory(ApicultureParticles.BEE_EXPLORER_PARTICLE.getParticleType(), BeeExploreParticle.Factory::new);

		Minecraft.getInstance().particles.registerFactory(ApicultureParticles.BEE_ROUND_TRIP_PARTICLE.getParticleType(), BeeRoundTripParticle.Factory::new);

		Minecraft.getInstance().particles.registerFactory(ApicultureParticles.BEE_TARGET_ENTITY_PARTICLE.getParticleType(), BeeTargetEntityParticle.Factory::new);
	}
}
