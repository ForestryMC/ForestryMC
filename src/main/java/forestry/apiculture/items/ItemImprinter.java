...
public class ItemImprinter extends ItemForestry {
					...
					BeeManager.beeRoot
							.templateAsGenome(
									BeeManager.beeRoot.getGenomeTemplates()
											.get(BeeManager.beeRoot.getIndividualTemplates().get(primaryIndex)
													.getIdent()),
							BeeManager.beeRoot.getGenomeTemplates()
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer) {
		if (Proxies.common.isSimulating(world)) {
			entityplayer.openGui(ForestryAPI.instance, GuiId.ImprinterGUI.ordinal(), world, (int) entityplayer.posX,
