...
public class TileAlvearySwarmer extends TileAlvearyWithGui
		implements ISidedInventory, IActivatable, IAlvearyComponent.Active {
	...
	private void trySpawnSwarm() {
		...
		if (HiveDecorator.genHive(worldObj, worldObj.rand, new BlockPos(chunkX, pos.getY(), chunkZ), hive)) {
			pendingSpawns.pop();
		}
	}
