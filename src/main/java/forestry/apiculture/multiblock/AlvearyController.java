...
public class AlvearyController extends RectangularMultiblockControllerBase implements IAlvearyController, IClimateControlled {
	...
	public int getBlockLightValue() {
		...
		return worldObj.getLightFromNeighbors(new BlockPos(topCenter.pos.getX(), topCenter.pos.getY() + 1, topCenter.pos.getZ()));
	}

	@Override
	public boolean canBlockSeeTheSky() {
		CoordTriplet topCenter = getTopCenterCoord();
		return worldObj.canBlockSeeSky(new BlockPos(topCenter.pos.getX(), topCenter.pos.getY() + 2, topCenter.pos.getZ()));
	}
