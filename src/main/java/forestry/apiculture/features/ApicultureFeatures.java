...
public class ApicultureFeatures {
	...
	public static final ConfiguredFeature<?, ?> HIVE_DECORATOR_CONF = HIVE_DECORATOR.configured(FeatureConfiguration.NONE);
	...
	public static void onBiomeLoad(BiomeLoadingEvent event) {
		event.getGeneration().addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, HIVE_DECORATOR_CONF.placed());
	}
}
