...
public class GuiHandlerApiculture extends GuiHandlerBase {
	...
	public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
		...
		case HygroregulatorGUI:
			return new GuiAlvearyHygroregulator(player.inventory,
					getTile(world, pos, player, TileAlvearyHygroregulator.class));
	...
	public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
		...
		case HygroregulatorGUI:
			return new ContainerAlvearyHygroregulator(player.inventory,
					getTile(world, pos, player, TileAlvearyHygroregulator.class));
