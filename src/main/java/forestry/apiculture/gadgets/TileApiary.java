...
public class TileApiary extends TileBeeHousing {
	...
	public void openGui(EntityPlayer player) {
		player.openGui(ForestryAPI.instance, GuiId.ApiaryGUI.ordinal(), worldObj, pos.getX(), pos.getY(), pos.getZ());
	}
	...
	private static class ApiaryBeeListener extends DefaultBeeListener {
		...
		public void wearOutEquipment(int amount) {
			IBeekeepingMode beekeepingMode = BeeManager.beeRoot.getBeekeepingMode(apiary.getWorld());
