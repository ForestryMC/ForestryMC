...
public class CommandBeeGive extends SubCommand {
	...
	public void processSubCommand(ICommandSender sender, String[] arguments)
			throws PlayerNotFoundException, SpeciesNotFoundException, TemplateNotFoundException {
		...
		CommandHelpers.sendLocalizedChatMessage(sender, "for.chat.command.forestry.bee.give.given",
				player.getCommandSenderName(), bee.getGenome().getPrimary().getName(), beeType.getName());
	}
	...
	public void printHelp(ICommandSender sender) {
		...
		CommandHelpers.sendLocalizedChatMessage(sender, "for.chat.command.forestry.beekeeping.give.available",
				beeTypeHelpString);
	}
}
