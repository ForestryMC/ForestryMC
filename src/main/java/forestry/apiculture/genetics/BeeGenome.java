...
public class BeeGenome extends Genome implements IBeeGenome {
	/**
	 * 0 - Species (determines product) 1 - Speed 2 - Lifespan 3 - Fertility
	 * (Maximum number of offspring) 4 - Preferred temperature Icy: Snow biomes
	 * Cold: Tundra/Steppe, Extreme Mountains/Hills? Normal: Plains, Forests,
	 * Mountains Hot: Desert Hellish: Nether 5 - Temperature tolerance (Range
	 * +/-) 6 - Nocturnal 7 - Preferred humidity (Arid - Normal - Damp) 8 -
	 * Humidity tolerance (Range +/-) 9 - Flight interference tolerance (stuff
	 * falling from the sky/other hindrances -> tolerates dampness + flight
	 * interference tolerance => rain resistance) 10 - Cave dwelling 11 -
	 * Required flowers 12 - Flower plant chance 13 - Territory
	 */
