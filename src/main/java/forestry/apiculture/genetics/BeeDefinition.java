...
public enum BeeDefinition implements IBeeDefinition {
	...
	FOREST(BeeBranchDefinition.HONEY, "nigrocincta", true, new Color(0x19d0ec), new Color(0xffdc16)) {
		...
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.HONEY, 1), 0.30f);
		}
	...
	COMMON(BeeBranchDefinition.HONEY, "cerana", true, new Color(0xb2b2b2), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.HONEY, 1), 0.35f);
		}
	...
	CULTIVATED(BeeBranchDefinition.HONEY, "mellifera", true, new Color(0x5734ec), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.HONEY, 1), 0.40f);
		}
	...
	NOBLE(BeeBranchDefinition.NOBLE, "nobilis", false, new Color(0xec9a19), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.DRIPPING, 1), 0.20f);
		}
	...
	MAJESTIC(BeeBranchDefinition.NOBLE, "regalis", true, new Color(0x7f0000), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.DRIPPING, 1), 0.30f);
		}
	...
	DILIGENT(BeeBranchDefinition.INDUSTRIOUS, "sedulus", false, new Color(0xc219ec), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.STRINGY, 1), 0.20f);
		}
	...
	UNWEARY(BeeBranchDefinition.INDUSTRIOUS, "assiduus", true, new Color(0x19ec5a), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.STRINGY, 1), 0.30f);
		}
	...
	INDUSTRIOUS(BeeBranchDefinition.INDUSTRIOUS, "industria", false, new Color(0xffffff), new Color(0xffdc16)) {
		...
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.STRINGY, 1), 0.20f)
				.addProduct(() -> ModuleApiculture.getItems().getPollen(EnumPollenCluster.NORMAL, 1), 0.15f)
				.setHasEffect();
		}
	...
	STEADFAST(BeeBranchDefinition.HEROIC, "legio", false, new Color(0x4d2b15), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.COCOA, 1), 0.20f)
				.setHasEffect();
		}
	...
	VALIANT(BeeBranchDefinition.HEROIC, "centurio", true, new Color(0x626bdd), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.COCOA, 1), 0.30f)
	...
	HEROIC(BeeBranchDefinition.HEROIC, "kraphti", false, new Color(0xb3d5e4), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.COCOA, 1), 0.40f)
				.setHasEffect();
		}
	...
	SINISTER(BeeBranchDefinition.INFERNAL, "caecus", false, new Color(0xb3d5e4), new Color(0x9a2323)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.SIMMERING, 1), 0.45f)
	...
	FIENDISH(BeeBranchDefinition.INFERNAL, "diabolus", true, new Color(0xd7bee5), new Color(0x9a2323)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.SIMMERING, 1), 0.55f)
	...
	MODEST(BeeBranchDefinition.AUSTERE, "modicus", false, new Color(0xc5be86), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.PARCHED, 1), 0.20f)
	...
	FRUGAL(BeeBranchDefinition.AUSTERE, "permodestus", true, new Color(0xe8dcb1), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.PARCHED, 1), 0.30f)
				.setTemperature(EnumTemperature.HOT)
				.setHumidity(EnumHumidity.ARID);
		}
	...
	AUSTERE(BeeBranchDefinition.AUSTERE, "correpere", false, new Color(0xfffac2), new Color(0xffdc16)) {
		...
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.PARCHED, 1), 0.20f)
				.addSpecialty(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.POWDERY, 1), 0.50f)
				.setHasEffect()
				.setTemperature(EnumTemperature.HOT)
				.setHumidity(EnumHumidity.ARID);
		}
	...
	TROPICAL(BeeBranchDefinition.TROPICAL, "mendelia", false, new Color(0x378020), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.SILKY, 1), 0.20f)
	...
	EXOTIC(BeeBranchDefinition.TROPICAL, "darwini", true, new Color(0x304903), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.SILKY, 1), 0.30f)
				.setTemperature(EnumTemperature.WARM)
				.setHumidity(EnumHumidity.DAMP);
		}
	...
	ENDED(BeeBranchDefinition.END, "notchi", false, new Color(0xe079fa), new Color(0xd9de9e)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.MYSTERIOUS, 1), 0.30f)
	...
	SPECTRAL(BeeBranchDefinition.END, "idolum", true, new Color(0xa98bed), new Color(0xd9de9e)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.MYSTERIOUS, 1), 0.50f)
				.setTemperature(EnumTemperature.COLD);
		}
	...
	PHANTASMAL(BeeBranchDefinition.END, "lemur", false, new Color(0xcc00fa), new Color(0xd9de9e)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.MYSTERIOUS, 1), 0.40f)
				.setHasEffect()
				.setTemperature(EnumTemperature.COLD);
		}
	...
	WINTRY(BeeBranchDefinition.FROZEN, "brumalis", false, new Color(0xa0ffc8), new Color(0xdaf5f3)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.FROZEN, 1), 0.30f)
	...
	ICY(BeeBranchDefinition.FROZEN, "coagulis", true, new Color(0xa0ffff), new Color(0xdaf5f3)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.FROZEN, 1), 0.20f)
				.addProduct(() -> ModuleCore.getItems().getCraftingMaterial(EnumCraftingMaterial.ICE_SHARD, 1), 0.20f)
				.setTemperature(EnumTemperature.ICY);
		}
	...
	GLACIAL(BeeBranchDefinition.FROZEN, "glacialis", false, new Color(0xefffff), new Color(0xdaf5f3)) {
		...
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.FROZEN, 1), 0.20f)
				.addProduct(() -> ModuleCore.getItems().getCraftingMaterial(EnumCraftingMaterial.ICE_SHARD, 1), 0.40f)
				.setTemperature(EnumTemperature.ICY)
				.setHasEffect();
		}
	...
	VINDICTIVE(BeeBranchDefinition.VENGEFUL, "ultio", false, new Color(0xeafff3), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.IRRADIATED, 1), 0.25f)
				.setIsNotCounted();
		}
	...
	VENGEFUL(BeeBranchDefinition.VENGEFUL, "punire", false, new Color(0xc2de00), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.IRRADIATED, 1), 0.40f)
				.setIsNotCounted();
		}
	...
	RURAL(BeeBranchDefinition.AGRARIAN, "rustico", false, new Color(0xfeff8f), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.WHEATEN, 1), 0.20f);
		}
	...
	FARMERLY(BeeBranchDefinition.AGRARIAN, "arator", true, new Color(0xD39728), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.WHEATEN, 1), 0.27f);
		}
	...
	AGRARIAN(BeeBranchDefinition.AGRARIAN, "arator", true, new Color(0xFFCA75), new Color(0xFFE047)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.WHEATEN, 1), 0.35f)
				.setHasEffect();
		}
	...
	MARSHY(BeeBranchDefinition.BOGGY, "adorasti", true, new Color(0x546626), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.MOSSY, 1), 0.30f)
				.setHumidity(EnumHumidity.DAMP);
		}
	...
	MIRY(BeeBranchDefinition.BOGGY, "humidium", true, new Color(0x92AF42), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.MOSSY, 1), 0.36f)
				.setHumidity(EnumHumidity.DAMP);
		}
	...
	BOGGY(BeeBranchDefinition.BOGGY, "paluster", true, new Color(0x698948), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.MOSSY, 1), 0.39f)
	...
	MONASTIC(BeeBranchDefinition.MONASTIC, "monachus", false, new Color(0x42371c), new Color(0xfff7b6)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addProduct(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.WHEATEN, 1), 0.30f)
				.addSpecialty(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.MELLOW, 1), 0.10f)
	...
	SECLUDED(BeeBranchDefinition.MONASTIC, "contractus", true, new Color(0x7b6634), new Color(0xfff7b6)) {
		@Override
		protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
			beeSpecies.addSpecialty(() -> ModuleApiculture.getItems().getComb(EnumHoneyComb.MELLOW, 1), 0.20f)
				.setJubilanceProvider(new JubilanceProviderHermit());
		}
	...
	BeeDefinition(BeeBranchDefinition branch, String binomial, boolean dominant, Color primary, Color secondary) {
		...
		this.branch = branch;
		IAlleleBeeSpeciesBuilder speciesBuilder = BeeManager.beeFactory.createSpecies(Constants.MOD_ID, species, dominant, "Sengir", name, description, branch.getBranch(), binomial, primary.getRGB(), secondary.getRGB());
		if (isSecret()) {
