...
public enum BeeDefinition implements IBeeDefinition {
	/* HONEY BRANCH */
	FOREST(EnumBeeBranch.HONEY, "nigrocincta", true, new Color(0x19d0ec), new Color(0xffdc16)) {
		@Override
	...
	MEADOWS(EnumBeeBranch.HONEY, "florea", true, new Color(0xef131e), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addProduct(ForestryItem.beeComb.getItemStack(1, 0), 30);
		}
	...
	COMMON(EnumBeeBranch.HONEY, "cerana", true, new Color(0xb2b2b2), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	CULTIVATED(EnumBeeBranch.HONEY, "mellifera", true, new Color(0x5734ec), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	/* NOBLE BRANCH */
	NOBLE(EnumBeeBranch.NOBLE, "nobilis", false, new Color(0xec9a19), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	MAJESTIC(EnumBeeBranch.NOBLE, "regalis", true, new Color(0x7f0000), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	IMPERIAL(EnumBeeBranch.NOBLE, "imperatorius", false, new Color(0xa3e02f), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addProduct(ForestryItem.beeComb.getItemStack(1, 5), 20)
	...
	/* INDUSTRIOUS BRANCH */
	DILIGENT(EnumBeeBranch.INDUSTRIOUS, "sedulus", false, new Color(0xc219ec), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	UNWEARY(EnumBeeBranch.INDUSTRIOUS, "assiduus", true, new Color(0x19ec5a), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	INDUSTRIOUS(EnumBeeBranch.INDUSTRIOUS, "industria", false, new Color(0xffffff), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addProduct(ForestryItem.beeComb.getItemStack(1, 3), 20)
	...
	/* HEROIC BRANCH */
	STEADFAST(EnumBeeBranch.HEROIC, "legio", false, new Color(0x4d2b15), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	VALIANT(EnumBeeBranch.HEROIC, "centurio", true, new Color(0x626bdd), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	HEROIC(EnumBeeBranch.HEROIC, "kraphti", false, new Color(0xb3d5e4), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	/* INFERNAL BRANCH */
	SINISTER(EnumBeeBranch.INFERNAL, "caecus", false, new Color(0xb3d5e4), new Color(0x9a2323)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	FIENDISH(EnumBeeBranch.INFERNAL, "diabolus", true, new Color(0xd7bee5), new Color(0x9a2323)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	DEMONIC(EnumBeeBranch.INFERNAL, "draco", false, new Color(0xf4e400), new Color(0x9a2323)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addProduct(ForestryItem.beeComb.getItemStack(1, 2), 45)
	...
	/* AUSTERE BRANCH */
	MODEST(EnumBeeBranch.AUSTERE, "modicus", false, new Color(0xc5be86), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	FRUGAL(EnumBeeBranch.AUSTERE, "permodestus", true, new Color(0xe8dcb1), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	AUSTERE(EnumBeeBranch.AUSTERE, "correpere", false, new Color(0xfffac2), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addProduct(ForestryItem.beeComb.getItemStack(1, 7), 20)
	...
	/* TROPICAL BRANCH */
	TROPICAL(EnumBeeBranch.TROPICAL, "mendelia", false, new Color(0x378020), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	EXOTIC(EnumBeeBranch.TROPICAL, "darwini", true, new Color(0x304903), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	EDENIC(EnumBeeBranch.TROPICAL, "humboldti", false, new Color(0x393d0d), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addProduct(ForestryItem.beeComb.getItemStack(1, 6), 20)
					.setEntityTexture("tropicalBee")
	...
	/* END BRANCH */
	ENDED(EnumBeeBranch.END, "notchi", false, new Color(0xe079fa), new Color(0xd9de9e)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	SPECTRAL(EnumBeeBranch.END, "idolum", true, new Color(0xa98bed), new Color(0xd9de9e)) {
	...
	PHANTASMAL(EnumBeeBranch.END, "lemur", false, new Color(0xcc00fa), new Color(0xd9de9e)) {
	...
	/* FROZEN BRANCH */
	WINTRY(EnumBeeBranch.FROZEN, "brumalis", false, new Color(0xa0ffc8), new Color(0xdaf5f3)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	ICY(EnumBeeBranch.FROZEN, "coagulis", true, new Color(0xa0ffff), new Color(0xdaf5f3)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	GLACIAL(EnumBeeBranch.FROZEN, "glacialis", false, new Color(0xefffff), new Color(0xdaf5f3)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addProduct(ForestryItem.beeComb.getItemStack(1, 4), 20)
	...
	/* VENGEFUL BRANCH */
	VINDICTIVE(EnumBeeBranch.VENGEFUL, "ultio", false, new Color(0xeafff3), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	VENGEFUL(EnumBeeBranch.VENGEFUL, "punire", false, new Color(0xc2de00), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	AVENGING(EnumBeeBranch.VENGEFUL, "hostimentum", false, new Color(0xddff00), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addProduct(ForestryItem.beeComb.getItemStack(1, 9), 40)
					.setHasEffect()
	...
	/* FESTIVE BRANCH */
	LEPORINE(EnumBeeBranch.FESTIVE, "lepus", false, new Color(0xfeff8f), new Color(0x3cd757)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addProduct(ForestryItem.beeComb.getItemStack(1, 6), 30)
	...
	MERRY(EnumBeeBranch.FESTIVE, "feliciter", false, new Color(0xffffff), new Color(0xd40000)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addProduct(ForestryItem.beeComb.getItemStack(1, 4), 30)
					.addProduct(ForestryItem.craftingMaterial.getItemStack(1, 5), 20)
	...
	TIPSY(EnumBeeBranch.FESTIVE, "ebrius", false, new Color(0xffffff), new Color(0xc219ec)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addProduct(ForestryItem.beeComb.getItemStack(1, 4), 30)
					.addProduct(ForestryItem.craftingMaterial.getItemStack(1, 5), 20)
	...
	// 35 Solstice
	TRICKY(EnumBeeBranch.FESTIVE, "libita", false, new Color(0x49413B), new Color(0xFF6A00)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addProduct(ForestryItem.beeComb.getItemStack(1, 0), 40)
	...
	/* AGRARIAN BRANCH */
	RURAL(EnumBeeBranch.AGRARIAN, "rustico", false, new Color(0xfeff8f), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	FARMERLY(EnumBeeBranch.AGRARIAN, "arator", true, new Color(0xD39728), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	AGRARIAN(EnumBeeBranch.AGRARIAN, "arator", true, new Color(0xFFCA75), new Color(0xFFE047)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	/* BOGGY BRANCH */
	MARSHY(EnumBeeBranch.BOGGY, "adorasti", true, new Color(0x546626), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	MIRY(EnumBeeBranch.BOGGY, "humidium", true, new Color(0x92AF42), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	BOGGY(EnumBeeBranch.BOGGY, "paluster", true, new Color(0x698948), new Color(0xffdc16)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	/* MONASTIC BRANCH */
	MONASTIC(EnumBeeBranch.MONASTIC, "monachus", false, new Color(0x42371c), new Color(0xfff7b6)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	SECLUDED(EnumBeeBranch.MONASTIC, "contractus", true, new Color(0x7b6634), new Color(0xfff7b6)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
	...
	HERMITIC(EnumBeeBranch.MONASTIC, "anachoreta", false, new Color(0xffd46c), new Color(0xfff7b6)) {
		@Override
		protected void setSpeciesProperties(AlleleBeeSpecies beeSpecies) {
			beeSpecies.addSpecialty(ForestryItem.beeComb.getItemStack(1, 16), 20)
					.setJubilanceProvider(new JubilanceProviderHermit())
	...
	private final EnumBeeBranch branch;
	private final AlleleBeeSpecies species;
	private IAllele[] template;
	private IBeeGenome genome;
	
	BeeDefinition(EnumBeeBranch branch, String binomial, boolean dominant, Color primary, Color secondary) {
