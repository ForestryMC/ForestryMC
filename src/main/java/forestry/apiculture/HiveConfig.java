...
public class HiveConfig {
	...
	private final Set<Biome.BiomeCategory> blacklistedTypes = new HashSet<>();
	...
	public HiveConfig(String[] entries) {
		for (String entry : entries) {
			Biome.BiomeCategory category = Biome.BiomeCategory.valueOf(entry);
	...
	private boolean isBlacklisted(Biome biome) {
		...
		return Arrays.stream(Biome.BiomeCategory.values()).anyMatch(blacklistedTypes::contains);
	}
