...
public class CharcoalBlocks {
    ...
    public static final FeatureBlock<BlockCharcoal, ItemBlockForestry> CHARCOAL = REGISTRY.block(
            BlockCharcoal::new,
            (block) -> new ItemBlockForestry<>(block, new ItemProperties(ModuleCharcoal.getGroup()).burnTime(16000)),
            "charcoal"
    );
    public static final FeatureBlock<BlockWoodPile, BlockItem> WOOD_PILE = REGISTRY.block(
            BlockWoodPile::new,
            (block) -> new ItemBlockForestry<>(block, new ItemProperties(ModuleCharcoal.getGroup()).burnTime(1200)),
            "wood_pile"
    );
    public static final FeatureBlock<BlockDecorativeWoodPile, BlockItem> WOOD_PILE_DECORATIVE = REGISTRY.block(
            BlockDecorativeWoodPile::new,
            (block) -> new ItemBlockForestry<>(block, new ItemProperties(ModuleCharcoal.getGroup()).burnTime(1200)),
