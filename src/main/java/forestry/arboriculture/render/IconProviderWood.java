...
public abstract class IconProviderWood {
	...
	public static void registerIcons(IIconRegister register) {
		...
		for (int i = 0; i < EnumWoodType.VALUES.length; i++) {
			...
			icons[0][i] = TextureManager.getSprite(register, "wood/planks." + woodName);
			icons[1][i] = TextureManager.getSprite(register, "wood/bark." + woodName);
			icons[2][i] = TextureManager.getSprite(register, "wood/heart." + woodName);
		}
	}
