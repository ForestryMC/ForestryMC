...
public class FeatureAcacia extends FeatureTree {
    ...
    public Set<BlockPos> generateTrunk(IWorld world, Random rand, TreeBlockTypeLog wood, BlockPos startPos) {
        ...
        Set<BlockPos> treeTops = FeatureHelper.generateTreeTrunk(
                world,
                rand,
                wood,
                startPos,
        ...
        if (height > 5 && rand.nextBoolean()) {
            ...
            Set<BlockPos> treeTops2 = FeatureHelper.generateTreeTrunk(
                    world,
                    rand,
                    wood,
                    startPos,
        ...
        for (BlockPos treeTop : treeTops) {
            ...
            branchEnds.addAll(FeatureHelper.generateBranches(
                    world,
                    rand,
                    wood,
                    pos,
    ...
    protected void generateLeaves(
        ...
        for (BlockPos branchEnd : branchEnds) {
            ...
            BlockPos center = new BlockPos(
                    branchEnd.getX(),
                    leafSpawn - canopyThickness + 1 + startPos.getY(),
                    branchEnd.getZ()
            );
