...
public class FruitProviderPod extends FruitProviderNone {
	...
	public void registerIcons() {
		...
		TextureManager.getInstance().registerTexUID(type.uids[0], "blocks", "pods/" + type.toString().toLowerCase(Locale.ENGLISH) + ".0");
		TextureManager.getInstance().registerTexUID(type.uids[1], "blocks", "pods/" + type.toString().toLowerCase(Locale.ENGLISH) + ".1");
		TextureManager.getInstance().registerTexUID(type.uids[2], "blocks", "pods/" + type.toString().toLowerCase(Locale.ENGLISH) + ".2");
	}
