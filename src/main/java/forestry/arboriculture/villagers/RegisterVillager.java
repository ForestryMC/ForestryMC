...
public class RegisterVillager {
    ...
    public static class Registers {
        ...
        public static final RegistryObject<PointOfInterestType> POI_TREE_CHEST = POINTS_OF_INTEREST.register(
                "tree_chest",
                () -> RegisterVillagerPointOfInterest.create(
                        "tree_chest",
                        RegisterVillagerPointOfInterest.assembleStates(
                                ArboricultureBlocks.TREE_CHEST.getBlock()
                        )
                )
        );
    ...
    public static class Events {
        ...
        public void villagerTrades(VillagerTradesEvent event) {
            if (ARBORIST.equals(event.getType().getRegistryName())) {
                event.getTrades()
                     .get(1)
                     .add(new GivePlanksForEmeralds(
                             new VillagerTrade.PriceInterval(1, 4),
                             new VillagerTrade.PriceInterval(10, 32),
                             8,
                             2,
                             0F
                     ));
                event.getTrades()
                     .get(1)
                     .add(new GivePollenForEmeralds(
                             new VillagerTrade.PriceInterval(1, 1),
                             new VillagerTrade.PriceInterval(1, 3),
                ...
                event.getTrades()
                     .get(2)
                     .add(new GivePollenForEmeralds(
                             new VillagerTrade.PriceInterval(2, 3),
                             new VillagerTrade.PriceInterval(1, 1),
                             EnumGermlingType.POLLEN,
                             6,
                             8,
                             6,
                             0F
                ...
                event.getTrades()
                     .get(2)
                     .add(new VillagerTrade.GiveItemForEmeralds(
                ...
                event.getTrades()
                     .get(3)
                     .add(new GiveLogsForEmeralds(
                             new VillagerTrade.PriceInterval(2, 5),
                             new VillagerTrade.PriceInterval(6, 18),
                             8,
                             2,
                             0F
                     ));
                ...
                event.getTrades()
                     .get(4)
                     .add(new GivePollenForEmeralds(
                             new VillagerTrade.PriceInterval(5, 20),
                             new VillagerTrade.PriceInterval(1, 1),
                             EnumGermlingType.POLLEN,
                             10,
                             8,
    ...
    private static class GivePlanksForEmeralds implements VillagerTrades.ITrade {
        ...
        public GivePlanksForEmeralds(
                VillagerTrade.PriceInterval emeraldsPriceInfo,
        ...
        public MerchantOffer getOffer(Entity trader, Random rand) {
            ...
            return new MerchantOffer(
                    new ItemStack(Items.EMERALD, emeraldsPriceInfo.getPrice(rand)),
                    sellStack,
                    maxUses,
                    xp,
                    priceMult
    ...
    private static class GivePollenForEmeralds implements VillagerTrades.ITrade {
        ...
        public MerchantOffer getOffer(Entity trader, Random rand) {
            ...
            return new MerchantOffer(
                    new ItemStack(Items.EMERALD, buyingPriceInfo.getPrice(rand)),
                    sellStack,
                    maxUses,
                    xp,
                    priceMult
