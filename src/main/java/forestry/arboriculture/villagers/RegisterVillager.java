...
public class RegisterVillager {
	...
	public static class Registers {
		...
		public static final RegistryObject<VillagerProfession> PROF_BEEKEEPER = PROFESSIONS.register(ARBORIST.getPath(), () -> RegisterVillagerProfession.create(ARBORIST, POI_TREE_CHEST.get(), SoundEvents.ENTITY_VILLAGER_WORK_FISHERMAN));
	}
