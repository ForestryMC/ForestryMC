...
public class ClientProxyArboriculture extends ProxyArboriculture {
	...
	public void initializeRendering() {
		Proxies.render.registerBlockModel(new BlockModelIndex(new ModelResourceLocation("forestry:leaves"),
				...
				ForestryBlock.leaves.block()));
		Proxies.render.registerBlockModel(new BlockModelIndex(new ModelResourceLocation("forestry:saplings"),
				new ModelResourceLocation("forestry:saplings", "inventory"), new SaplingRenderHandler(),
				ForestryBlock.saplingGE.block()));
	}
