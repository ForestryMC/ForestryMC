...
public class BlockSapling extends BlockTreeContainer implements IGrowable, ISpriteRegister {
	...
	private static void dropAsSapling(World world, BlockPos pos) {
		...
		TileSapling sapling = getSaplingTile(world, pos);
		if (sapling != null && sapling.getTree() != null) {
			ItemStack saplingStack = TreeManager.treeRoot.getMemberStack(sapling.getTree(),
