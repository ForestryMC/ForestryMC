...
public class ForestryBlockLeaves extends BlockLeavesBase
		implements ITileEntityProvider, IGrowable, IShearable, IModelRegister {
	...
	/* DROP HANDLING */
	// Hack: When harvesting leaves we need to get the drops in
	// onBlockHarvested,
	...
	private static ArrayList<ItemStack> getLeafDrop(World world, @Nullable GameProfile playerProfile, BlockPos pos,
			float saplingModifier, int fortune) {
	...
	public void registerModel(Item item, IModelManager manager) {
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(item, 0,
				new ModelResourceLocation("forestry:leaves", "inventory"));
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumFacing side,
		...
		if (heldItem != null && (heldItem.getItem() instanceof IToolScoop) && caterpillar != null) {
			ItemStack butterfly = PluginLepidopterology.butterflyInterface.getMemberStack(caterpillar,
