...
public class ItemGermlingGE extends ItemGE implements IVariableFermentable {
	...
	public boolean onItemUse(ItemStack itemstack, EntityPlayer player, World world, BlockPos pos, EnumFacing side,
		...
		if (type == EnumGermlingType.SAPLING) {
			...
			if (TreeManager.treeRoot.plantSapling(world, tree, player.getGameProfile(),
					new BlockPos(pos.getX(), pos.getY() + yShift, pos.getZ()))) {
				Proxies.common.addBlockPlaceEffects(world, new BlockPos(pos.getX(), pos.getY(), pos.getZ()),
						world.getBlockState(new BlockPos(pos.getX(), pos.getY() + yShift, pos.getZ())));
			...
			ICheckPollinatable checkPollinatable = GeneticsUtil.getCheckPollinatable(world,
			...
			IPollinatable pollinatable = GeneticsUtil.getOrCreatePollinatable(player.getGameProfile(), world,
					new BlockPos(pos.getX(), pos.getY(), pos.getZ()));
