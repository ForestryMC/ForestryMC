...
public class AlleleFruits {
    ...
    static {
        ...
        fruitAlleles = Arrays.asList(
                ...
                fruitApple = new AlleleFruit("apple", new FruitProviderRipening(
                        "for.fruits.apple",
                        POMES,
                ...
                fruitCocoa = new AlleleFruit(
                        "cocoa",
                        new FruitProviderPod("for.fruits.cocoa", JUNGLE, EnumPodType.COCOA, () -> cocoaBean)
                ),
                // .setColours(0xecdca5, 0xc4d24a), true)
                fruitChestnut = new AlleleFruit("chestnut", new FruitProviderRipening(
                        "for.fruits.chestnut",
                        NUX,
                        () -> CoreItems.FRUITS.stack(EnumFruit.CHESTNUT, 1),
                        1.0f
                )
                        .setRipeningPeriod(6)
                        .setColours(new Color(0x7f333d), new Color(0xc4d24a))
                        .setOverlay("nuts"), true),
                fruitWalnut = new AlleleFruit("walnut", new FruitProviderRipening(
                        "for.fruits.walnut",
                        NUX,
                        () -> CoreItems.FRUITS.stack(EnumFruit.WALNUT, 1),
                        1.0f
                )
                        .setRipeningPeriod(8)
                        .setColours(new Color(0xfba248), new Color(0xc4d24a))
                        .setOverlay("nuts"), true),
                fruitCherry = new AlleleFruit("cherry", new FruitProviderRipening(
                        "for.fruits.cherry",
                        PRUNES,
                        () -> CoreItems.FRUITS.stack(EnumFruit.CHERRY, 1),
                        1.0f
                )
                ...
                fruitDates = new AlleleFruit(
                        ...
                        new FruitProviderPod(
                                ...
                                JUNGLE,
                                EnumPodType.DATES,
                                () -> CoreItems.FRUITS.stack(EnumFruit.DATES, 4)
                        )
                ),
                fruitPapaya = new AlleleFruit(
                        ...
                        new FruitProviderPod(
                                ...
                                JUNGLE,
                                EnumPodType.PAPAYA,
                                () -> CoreItems.FRUITS.stack(EnumFruit.PAPAYA, 1)
                        )
                ),
                fruitLemon = new AlleleFruit("lemon", new FruitProviderRipening(
                        "for.fruits.lemon",
                        PRUNES,
                        () -> CoreItems.FRUITS.stack(EnumFruit.LEMON, 1),
                        1.0f
                )
                        .setColours(new Color(0xeeee00), new Color(0x99ff00))
                        .setOverlay("citrus"), true),
                fruitPlum = new AlleleFruit("plum", new FruitProviderRipening(
                        "for.fruits.plum",
                        PRUNES,
                        () -> CoreItems.FRUITS.stack(EnumFruit.PLUM, 1),
                        1.0f
                )
