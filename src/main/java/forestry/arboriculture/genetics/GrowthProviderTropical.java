...
public class GrowthProviderTropical extends GrowthProvider {
    ...
    public EnumGrowthConditions getGrowthConditions(ITreeGenome genome, World world, int xPos, int yPos, int zPos) {
        ...
        EnumGrowthConditions moisture = getConditionsFromRainfall(
                world,
                xPos,
                yPos,
                zPos,
                BiomeGenBase.jungle.rainfall,
                2.0f);
        ...
        EnumGrowthConditions temperature = getConditionsFromTemperature(
                world,
                xPos,
                yPos,
                zPos,
                jungleTemperature,
                desertTemperature - 0.1f);
