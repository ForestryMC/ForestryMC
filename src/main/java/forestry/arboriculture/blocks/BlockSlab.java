...
public class BlockSlab extends net.minecraft.block.BlockSlab implements IWoodTyped, IModelRegister, ITileEntityProvider {
	...
	public BlockSlab(boolean fireproof) {
		...
		setDefaultState(this.blockState.getBaseState().withProperty(EnumWoodType.WOODTYPE, EnumWoodType.LARCH).withProperty(HALF, EnumBlockHalf.BOTTOM));
	}

	@Override
	protected BlockState createBlockState() {
		return new BlockState(this, new IProperty[] { HALF, EnumWoodType.WOODTYPE });
	}
