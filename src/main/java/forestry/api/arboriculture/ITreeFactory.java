...
public interface ITreeFactory {
    ...
    /**
     * Creates a new tree species. Automatically registered with AlleleManager.alleleRegistry.registerAllele() See
     * IAlleleTreeSpeciesCustom and IAlleleSpeciesCustom for adding additional properties to the returned species.
     *
     ...
     */
    IAlleleTreeSpeciesCustom createSpecies(String uid, String unlocalizedName, String authority,
            String unlocalizedDescription, boolean dominant, IClassification branch, String binomial,
            ILeafIconProvider leafIconProvider, IGermlingIconProvider germlingIconProvider, ITreeGenerator generator);
