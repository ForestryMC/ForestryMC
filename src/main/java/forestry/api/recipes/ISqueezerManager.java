...
public interface ISqueezerManager extends ICraftingProvider<ISqueezerRecipe> {
     ...
     * @param resources   Array of item stacks representing the required resources for one process. Stack size will be
     *                    taken into account.
    ...
    /**
     * Add a recipe for a fluid container to the squeezer. This will add recipes to get all types of liquids out of this
