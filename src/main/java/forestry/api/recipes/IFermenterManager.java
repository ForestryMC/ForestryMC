 ...
 * BaseMod.ModsLoaded() and this shouldn't be null even if your mod loads before Forestry.
 *
...
public interface IFermenterManager extends ICraftingProvider<IFermenterRecipe> {
     ...
     * @param fermentationValue Value of the given resource, i.e. how much needs to be fermented for the output to be
     *                          deposited into the product tank.
     * @param modifier          Modifies the amount of liquid output per work cycle. (water = 1.0f, honey = 1.5f)
     * @param output            LiquidStack representing output liquid. Amount is determined by
     *                          fermentationValue*modifier.
