...
public interface IBeeFactory {
    ...
    /**
     * Creates a new bee species. Automatically registered with AlleleManager.alleleRegistry.registerAllele() See
     * IAlleleBeeSpeciesCustom and IAlleleSpeciesCustom for adding additional properties to the returned species.
     *
     ...
     * @param binomial               Binomial name of the species sans genus ("Apis"). "humboldti" will have the bee
     *                               species flavour name be "Apis humboldti". Feel free to use fun names or null.
     ...
     */
    IAlleleBeeSpeciesCustom createSpecies(String uid, boolean dominant, String authority, String unlocalizedName,
            String unlocalizedDescription, IClassification branch, String binomial, int primaryColor,
            int secondaryColor);

    /**
     * Creates a new bee branch. Must be registered with
     * AlleleManager.alleleRegistry.getClassification("family.apidae").addMemberGroup();
     *
