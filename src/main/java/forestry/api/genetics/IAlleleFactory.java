 ...
 *
 *
 * UID is created like this: modId + '.' + category + WordUtils.capitalize(valueName); For Example: modId:forestry,
 * category:height, valueName:smallest => forestry.heightSmallest This is mainly for legacy compatibility and may change
 ...
 *
 * For example: en_US forestry.allele.smallest=Smallest ru_RU forestry.allele.smallest=????? ?????????
...
public interface IAlleleFactory {
     ...
     * @since Forestry 4.2
     */
    IAlleleArea createArea(String modId, String category, String valueName, int xDimValue, int yDimValue, int zDimValue,
     ...
     * @return a new IAlleleBoolean, registered with the allele registry. Note that valueName will always be "true" or
     *         "false"
     * @since Forestry 4.2
     */
     ...
     * @return a new IAlleleFlowers, registered with the allele registry. IAlleleFlowers localization is handled by the
     *         IFlowerProvider.getDescription(), unlike the other alleles.
     * @since Forestry 4.2
     */
    IAlleleFlowers createFlowers(String modId, String category, String valueName, IFlowerProvider value,
            boolean isDominant, IChromosomeType... types);
