...
public interface IFlowerGrowthRule {
    ...
    /**
     * Checks a position for suitability, and then plants a flower there. Returns true on success. For implementers, you
     * can plant a random flower using IFlowerGrowthHelper.plantRandomFlower
     * 
    ...
    /**
     * Checks a position for suitability, and then plants a flower there. Returns true on success. For implementers, get
     * a flower to grow using IFlowerRegistry.getRandomPlantableFlower
     * 
