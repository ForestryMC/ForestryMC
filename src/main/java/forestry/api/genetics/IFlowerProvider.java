...
public interface IFlowerProvider {
    ...
    /**
     * Allows the flower provider to affect the produce at the given location. If this flowerProvider does not affect
     * the products, it should return the products unchanged.
     * 
    ...
    /**
     * @return Set of valid flowers for the flower provider. Returns an empty set if the flower provider does not have
     *         any valid flowers.
     ...
     * @deprecated since Forestry 4.0.8 Use IFlowerRegistry.growFlower. Implementers can move logic into a
     *             IFlowerGrowthRule and register with IFlowerRegistry.registerGrowthRule
     */
    @Deprecated
