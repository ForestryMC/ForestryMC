...
public interface IFlowerRegistry {
    ...
    /**
     * Register a new flower growth rule. This defines the flower planting logic for the specified flower types. Without
     * a flower growth rule, no flowers of that type can be planted.
     */
    ...
    /**
     * Registers custom logic for accepted flowers. These rules are inefficient compared to ones made with
     * registerAcceptableFlower, but may be necessary for tile entity flowers. The flower types built into Forestry can
     * not be used here.
     * 
    ...
    /**
     * Registers a plantable flower. The distribution is based on its own weight and the total number of plants for this
     * flowerType.
     *
