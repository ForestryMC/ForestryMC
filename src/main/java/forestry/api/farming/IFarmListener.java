...
public interface IFarmListener {
     ...
     *
     * @param harvested Collection of harvested stacks. May be manipulated. Ensure removal of stacks with 0 or less
     *                  items!
     ...
     *
     * @param collected Collection of collected stacks. May be manipulated. Ensure removal of stacks with 0 or less
     *                  items!
     */
     ...
     */
    void hasCultivated(IFarmLogic logic, int x, int y, int z, FarmDirection direction, int extent);
    ...
    void hasScheduledHarvest(Collection<ICrop> harvested, IFarmLogic logic, int x, int y, int z,
            FarmDirection direction, int extent);
