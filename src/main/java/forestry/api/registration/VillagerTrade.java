...
public class VillagerTrade {
	...
	public static class GiveEmeraldForItem implements VillagerTrades.ITrade {
		...
		public GiveEmeraldForItem(@Nonnull Item buyingItem, @Nonnull PriceInterval buyingAmounts, @Nonnull PriceInterval emeraldAmounts, int maxUses, int xp) {
	...
	public static class GiveItemForItemAndEmerald implements VillagerTrades.ITrade {
		...
		public GiveItemForItemAndEmerald(@Nonnull Item buyingItem, @Nonnull PriceInterval buyAmounts, @Nonnull PriceInterval emeralsAmounts, @Nonnull Item sellingItem, @Nonnull PriceInterval sellingAmounts, int maxUses, int xp) {
			this.buyingItem = buyingItem;
	...
	public static class GiveItemForLogAndEmerald implements VillagerTrades.ITrade {
		...
		public GiveItemForLogAndEmerald(@Nonnull PriceInterval buyAmounts, @Nonnull PriceInterval emeraldAmounts, @Nonnull Item sellingItem, @Nonnull PriceInterval sellingAmounts, int maxUses, int xp) {
			this.buyAmounts = buyAmounts;
			this.emeraldAmounts = emeraldAmounts;
			this.sellingItem = sellingItem;
			this.sellingAmounts = sellingAmounts;
	...
	public static class GiveItemForTwoItems implements VillagerTrades.ITrade {
		...
		public GiveItemForTwoItems(@Nonnull Item buyingItem, @Nonnull PriceInterval buyAmounts, @Nonnull Item buyingItem2, @Nonnull PriceInterval buyAmounts2, @Nonnull Item sellingItem, @Nonnull PriceInterval sellingAmounts, int maxUses, int xp) {
			this.buyingItem = buyingItem;
			this.buyAmounts = buyAmounts;
