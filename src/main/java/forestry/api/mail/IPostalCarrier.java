 ...
 *
 * The two available carriers in vanilla Forestry are "player" - Delivers mail to individual players. "trader" - Handles
 * mail addressed to trade stations.
 */
public interface IPostalCarrier {
     ...
     */
    IPostalState deliverLetter(World world, IPostOffice office, IMailAddress recipient, ItemStack letterstack,
            boolean doDeliver);
}
