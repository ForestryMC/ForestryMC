...
public class FarmLedger extends Ledger {
	...
	public void draw(int x, int y) {
		...
		drawText(StringUtil.floatAsPercent(delegate.getHydrationRainfallModifier()) + " (" + delegate.getDrought()
				+ " d)", x + 22, y + 80);
	...
	public static void registerSprite() {
		sprite = TextureManager.getInstance().registerTex("minecraft", "items", "bucket_water");
	}
}