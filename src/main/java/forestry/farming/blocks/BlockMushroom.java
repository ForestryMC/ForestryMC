...
public class BlockMushroom extends BlockBush implements IItemTyped, IModelRegister, IGrowable {
	...
	public void generateTree(World world, BlockPos pos, IBlockState state, Random rand) {
		MushroomType type = getTypeFromMeta(BlockPosUtil.getBlockMeta(world, pos));
