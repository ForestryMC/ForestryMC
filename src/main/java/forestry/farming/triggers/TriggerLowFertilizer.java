...
public class TriggerLowFertilizer extends Trigger {
    ...
    @Override
    public boolean isTriggerActive(TileEntity tile, ForgeDirection side, IStatementContainer source,
        ...
        IInventory fertilizerInventory = tileHatch.getMultiblockLogic().getController().getFarmInventory()
