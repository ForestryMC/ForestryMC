...
public class FarmingTriggers {
	...
	public static void initialize() {
		allExternalTriggers = Arrays.<ITriggerExternal> asList(
				...
				lowResourceLiquid25 = new TriggerLowLiquid("lowLiquid.25", 0.25f), lowSoil128 = new TriggerLowSoil(128),
				lowSoil64 = new TriggerLowSoil(64), lowSoil32 = new TriggerLowSoil(32),
