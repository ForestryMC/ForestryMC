...
public class FarmInventory extends InventoryAdapterRestricted implements IFarmInventory {
	...
	public static final int SLOT_COUNT = SLOT_RESOURCES_COUNT + SLOT_GERMLINGS_COUNT + SLOT_PRODUCTION_COUNT
			+ SLOT_FERTILIZER_COUNT + SLOT_CAN_COUNT;
	...
	public void removeResources(ItemStack[] resources) {
		EntityPlayer player = Proxies.common.getPlayer(farmController.getWorld(),
				farmController.getAccessHandler().getOwner());
