...
public abstract class TileFarm extends RectangularMultiblockTileEntityBase
		implements IFarmComponent, IHintSource, ISocketable, IStreamableGui, IErrorLogicSource {
	...
	public void openGui(EntityPlayer player) {
		if (this.isConnected()) {
			player.openGui(ForestryAPI.instance, GuiId.MultiFarmGUI.ordinal(), worldObj, pos.getX(), pos.getY(),
					pos.getZ());
		}
	}
