...
public class BlockFarm extends BlockStructure {
	...
	private static class ParticleCallback implements ParticleHelperCallback {
		...
		private static void setTexture(EntityDiggingFX fx, World world, int x, int y, int z) {
			fx.setParticleIcon(EnumFarmBlockTexture.getIcon(ForestryBlock.farm.block().getMetaFromState(world.getBlockState(new BlockPos(x, y, z)))).getSprite());
		}
	}
	...
	public boolean addDestroyEffects(World world, BlockPos pos, EffectRenderer effectRenderer) {
		return ParticleHelper.addDestroyEffects(world, instance, pos, world.getBlockState(pos), effectRenderer, callback);
	}
