...
public class FarmHelper {
	...
	public static final ImmutableSet<Block> bricks = ImmutableSet.of(Blocks.BRICKS, Blocks.STONE_BRICKS, Blocks.SANDSTONE, Blocks.NETHER_BRICKS, Blocks.QUARTZ_BLOCK);
