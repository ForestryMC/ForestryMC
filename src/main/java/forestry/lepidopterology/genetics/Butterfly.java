...
public class Butterfly extends IndividualLiving implements IButterfly {
	...
	public void addTooltip(List<String> list) {
		...
		if (!isPureBred(EnumButterflyChromosome.SPECIES)) {
			list.add(EnumChatFormatting.BLUE + StringUtil.localize("butterflies.hybrid")
	...
	public void readFromNBT(NBTTagCompound nbttagcompound) {
		...
		if (nbttagcompound == null) {
			this.genome = PluginLepidopterology.butterflyInterface
					.templateAsGenome(PluginLepidopterology.butterflyInterface.getDefaultTemplate());
			return;
		}
		...
		if (nbttagcompound.hasKey("Genome")) {
			...
			genome = PluginLepidopterology.butterflyInterface
					.templateAsGenome(PluginLepidopterology.butterflyInterface.getDefaultTemplate());
		}
	...
	public boolean canSpawn(World world, double x, double y, double z) {
		...
		BiomeGenBase biome = world.getBiomeGenForCoordsBody(new BlockPos(x, y, z));
