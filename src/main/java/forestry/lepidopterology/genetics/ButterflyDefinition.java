...
public enum ButterflyDefinition implements IButterflyDefinition {
	...
	}, Brimstone(ButterflyBranchDefinition.GONEPTERYX, "brimstone", "rhamni", new Color(0xf0ee38), true, 1.0f), Aurora(ButterflyBranchDefinition.ANTHOCHARIS, "orangeTip", "cardamines", new Color(0xe34f05), true, 0.5f) {
		@Override
		protected void setAlleles(IAlleleTemplateBuilder template) {
	...
	}, Postman(ButterflyBranchDefinition.HELICONIUS, "postman", "melpomene", new Color(0xf7302d), true, 0.3f), Malachite(ButterflyBranchDefinition.SIPROETA, "malachite", "stelenes", new Color(0xbdff53), true, 0.5f) {
		@Override
		protected void setSpeciesProperties(IAlleleButterflySpeciesBuilder species) {
			species.setTemperature(EnumTemperature.WARM).setHumidity(EnumHumidity.DAMP);
		}
