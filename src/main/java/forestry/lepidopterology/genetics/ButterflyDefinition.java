...
public enum ButterflyDefinition implements IButterflyDefinition {
    ...
    CitrusSwallow(ButterflyBranchDefinition.Papilio, "swallowtailC", "demodocus", new Color(0xeae389), false, 1.0f) {
        ...
        protected void setAlleles(IAllele[] alleles) {
            ...
            AlleleHelper.instance
                    .set(alleles, EnumButterflyChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.DOWN_1);
    ...
    ZebraSwallow(ButterflyBranchDefinition.Protographium, "swallowtailZ", "marcellus", new Color(0xeafeff), true,
            0.5f) {
    ...
    BlueDuke(ButterflyBranchDefinition.Bassarona, "blueDuke", "durga", new Color(0x304240), true, 0.5f) {
        ...
        protected void setAlleles(IAllele[] alleles) {
            AlleleHelper.instance
                    .set(alleles, EnumButterflyChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.BOTH_1);
        }
    },
    ...
    LLacewing(ButterflyBranchDefinition.Cethosia, "leopardLacewing", "cyane", new Color(0xfb8a06), true, 0.7f) {
        ...
        protected void setAlleles(IAllele[] alleles) {
            AlleleHelper.instance
                    .set(alleles, EnumButterflyChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.UP_1);
    ...
    ButterflyDefinition(ButterflyBranchDefinition branchDefinition, String speciesName, String binomial,
            Color serumColor, boolean dominant, float rarity) {
        ...
        species = ButterflyManager.butterflyFactory.createSpecies(
                "forestry." + uid,
                unlocalizedName,
                "Sengir",
