...
public enum ButterflyDefinition implements IButterflyDefinition {
	CabbageWhite(ButterflyBranchDefinition.Pieris, "cabbageWhite", "rapae", new Color(0xccffee), true, 1.0f) {
		...
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.SIZE, EnumAllele.Size.AVERAGE);
		}
	},
	...
	Aurora(ButterflyBranchDefinition.Anthocharis, "orangeTip", "cardamines", new Color(0xe34f05), true, 0.5f) {
		@Override
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.SIZE, EnumAllele.Size.SMALLER);
		}
	},
	Postillion(ButterflyBranchDefinition.Colias, "postillion", "croceus", new Color(0xd77e04), true, 0.5f) {
		@Override
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.SPEED, EnumAllele.Speed.SLOW);
		}
	},
	PalaenoSulphur(ButterflyBranchDefinition.Colias, "palaenoSulphur", "palaeno", new Color(0xf8fba3), true, 0.4f) {
		@Override
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.SPEED, EnumAllele.Speed.SLOWER);
		}
	},
	...
	SpringAzure(ButterflyBranchDefinition.Celastrina, "springAzure", "argiolus", new Color(0xb8cae2), true, 0.3f) {
		...
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.SIZE, EnumAllele.Size.SMALLER);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.LIFESPAN, EnumAllele.Lifespan.SHORT);
		}
	},
	...
	CitrusSwallow(ButterflyBranchDefinition.Papilio, "swallowtailC", "demodocus", new Color(0xeae389), false, 1.0f) {
		...
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.SPEED, EnumAllele.Speed.SLOWER);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.SIZE, EnumAllele.Size.LARGE);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.FERTILITY, 10);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.METABOLISM, 8);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.LIFESPAN, EnumAllele.Lifespan.SHORTER);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.DOWN_1);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.HUMIDITY_TOLERANCE, EnumAllele.Tolerance.DOWN_1);
		}
	},
	EmeraldPeacock(ButterflyBranchDefinition.Papilio, "emeraldPeacock", "palinurus", new Color(0x7cfe80), true, 0.1f) {
		...
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.SIZE, EnumAllele.Size.LARGE);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.LIFESPAN, EnumAllele.Lifespan.NORMAL);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.FERTILITY, 5);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.DOWN_1);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.HUMIDITY_TOLERANCE, EnumAllele.Tolerance.DOWN_1);
		}
	},
	ThoasSwallow(ButterflyBranchDefinition.Papilio, "swallowtailT", "thoas", new Color(0xeac783), false, 0.2f) {
		...
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.SPEED, EnumAllele.Speed.SLOWER);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.SIZE, EnumAllele.Size.LARGE);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.LIFESPAN, EnumAllele.Lifespan.SHORTEST);
		}
	},
	...
	SpeckledWood(ButterflyBranchDefinition.Pararge, "speckledWood", "aegeria", new Color(0x947245), true, 1.0f) {
		@Override
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.FERTILITY, 2);
		}
	},
	...
	MBlueMorpho(ButterflyBranchDefinition.Morpho, "blueMorphoM", "menelaus", new Color(0x72e1fd), true, 0.5f) {
		...
		@Override
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.SIZE, EnumAllele.Size.LARGER);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.LIFESPAN, EnumAllele.Lifespan.SHORTEST);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.FERTILITY, 2);
		}
	},
	...
	BlueWing(ButterflyBranchDefinition.Myscelia, "blueWing", "ethusa", new Color(0x3a93cc), true, 0.3f) {
		...
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.SIZE, EnumAllele.Size.AVERAGE);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.METABOLISM, 5);
		}
	},
	...
	BlueDuke(ButterflyBranchDefinition.Bassarona, "blueDuke", "durga", new Color(0x304240), true, 0.5f) {
		...
		@Override
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.BOTH_1);
		}
	},
	...
	LLacewing(ButterflyBranchDefinition.Cethosia, "leopardLacewing", "cyane", new Color(0xfb8a06), true, 0.7f) {
		@Override
		protected void setAlleles(Map<ButterflyChromosome, IAllele> alleles) {
			AlleleHelper.instance.set(alleles, ButterflyChromosome.TEMPERATURE_TOLERANCE, EnumAllele.Tolerance.UP_1);
			AlleleHelper.instance.set(alleles, ButterflyChromosome.HUMIDITY_TOLERANCE, EnumAllele.Tolerance.UP_1);
		}
	},
