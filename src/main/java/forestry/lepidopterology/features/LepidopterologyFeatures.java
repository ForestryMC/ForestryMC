...
public class LepidopterologyFeatures {
	...
	public static final ConfiguredFeature<?, ?> COCOON_DECORATOR_CONF = COCOON_DECORATOR.withConfiguration(NoFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Placement.NOPE.configure(IPlacementConfig.NO_PLACEMENT_CONFIG));
