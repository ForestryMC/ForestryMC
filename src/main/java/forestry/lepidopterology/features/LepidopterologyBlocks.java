...
public class LepidopterologyBlocks {
	...
	public static final FeatureBlock<BlockLepidopterology, ItemBlockBase> BUTTERFLY_CHEST = REGISTRY
			.block(() -> new BlockLepidopterology(BlockTypeLepidopterologyTesr.LEPICHEST), (block) -> new ItemBlockBase<>(block, new Item.Properties()
					.group(ItemGroups.tabLepidopterology), BlockTypeLepidopterologyTesr.LEPICHEST), "butterfly_chest");
	public static final FeatureBlock<BlockCocoon, BlockItem> COCOON = REGISTRY.block(BlockCocoon::new, "cocoon");
	public static final FeatureBlock<BlockSolidCocoon, BlockItem> COCOON_SOLID = REGISTRY
			.block(BlockSolidCocoon::new, "cocoon_solid");
}
