...
public class LepidopterologyTiles {
    ...
    public static final FeatureTileType<TileCocoon> SOLID_COCOON = REGISTRY.tile(() -> new TileCocoon(true), "solid_cocoon", LepidopterologyBlocks.COCOON_SOLID::collect);
    public static final FeatureTileType<TileCocoon> COCOON = REGISTRY.tile(() -> new TileCocoon(false), "cocoon", LepidopterologyBlocks.COCOON::collect);
