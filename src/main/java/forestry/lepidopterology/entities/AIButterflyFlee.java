...
public class AIButterflyFlee extends AIButterflyMovement {
    ...
    public boolean shouldExecute() {
        ...
        EntityPlayer player = entity.worldObj
                .getClosestPlayerToEntity(entity, entity.getButterfly().getGenome().getPrimary().getFlightDistance());
        ...
        if (player.getDistanceSq(flightTarget.xCoord, flightTarget.yCoord, flightTarget.zCoord)
                < player.getDistanceSqToEntity(entity)) {
            return false;
        }
