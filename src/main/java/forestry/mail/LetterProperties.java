...
public class LetterProperties {
	...
	public static void registerIcons(IIconRegister register) {
		icons = new IIcon[3][4];
		for (int i = 0; i < 3; i++) {
			icons[i][0] = TextureManager.getSprite(register, "mail/letter." + i + ".fresh");
			icons[i][1] = TextureManager.getSprite(register, "mail/letter." + i + ".stamped");
			icons[i][2] = TextureManager.getSprite(register, "mail/letter." + i + ".opened");
			icons[i][3] = TextureManager.getSprite(register, "mail/letter." + i + ".emptied");
		}
	}
