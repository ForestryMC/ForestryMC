...
public class GuiHandlerMail extends GuiHandlerBase {
	...
	public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
		...
		switch (GuiId.values()[id]) {
			...
			case MailboxGUI:
				return new GuiMailbox(player.inventory, getTileForestry(world, x, y, z, MachineMailbox.class));
			case PhilatelistGUI:
				return new GuiPhilatelist(player.inventory, getTileForestry(world, x, y, z, MachinePhilatelist.class));
			case TraderGUI:
				return new GuiTrader(player.inventory, getTileForestry(world, x, y, z, MachineTrader.class));
			case TraderNameGUI:
				return new GuiTradeName(player.inventory, getTileForestry(world, x, y, z, MachineTrader.class));
			default:
				return null;
	...
	public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
		...
		switch (GuiId.values()[id]) {
			...
			case MailboxGUI:
				return new ContainerMailbox(player.inventory, getTileForestry(world, x, y, z, MachineMailbox.class));
			case PhilatelistGUI:
				return new ContainerPhilatelist(player.inventory, getTileForestry(world, x, y, z, MachinePhilatelist.class));
			case TraderGUI:
				return new ContainerTrader(player.inventory, getTileForestry(world, x, y, z, MachineTrader.class));
			case TraderNameGUI:
				return new ContainerTradeName(player.inventory, getTileForestry(world, x, y, z, MachineTrader.class));
			default:
				return null;
