...
public enum EnumStampDefinition implements ItemOverlay.IOverlayInfo {
	P_1("1n", EnumPostage.P_1, Ingredient.fromTag(ForestryTags.Items.GEM_APATITE), new Color(0x4a8ca7), new Color(0xffffff)),
	P_2("2n", EnumPostage.P_2, Ingredient.fromTag(ForestryTags.Items.INGOT_COPPER), new Color(0xe8c814), new Color(0xffffff)),
	P_5("5n", EnumPostage.P_5, Ingredient.fromTag(ForestryTags.Items.INGOT_TIN), new Color(0x9c0707), new Color(0xffffff)),
	P_10("10n", EnumPostage.P_10, Ingredient.fromTag(Tags.Items.INGOTS_GOLD), new Color(0x7bd1b8), new Color(0xffffff)),
	P_20("20n", EnumPostage.P_20, Ingredient.fromTag(Tags.Items.GEMS_DIAMOND), new Color(0xff9031), new Color(0xfff7dd)),
	P_50("50n", EnumPostage.P_50, Ingredient.fromTag(Tags.Items.GEMS_EMERALD), new Color(0x6431d7), new Color(0xfff7dd)),
	P_100("100n", EnumPostage.P_100, Ingredient.fromTag(Tags.Items.NETHER_STARS), new Color(0xd731ba), new Color(0xfff7dd)),
