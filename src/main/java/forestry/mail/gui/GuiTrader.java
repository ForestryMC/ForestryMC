...
public class GuiTrader extends GuiForestry<ContainerTrader, MachineTrader> {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		this.fontRendererObj.drawString(receive, getCenteredOffset(receive, 70) + 51, 45,
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int mouseX, int mouseY) {
		...
		fontRendererObj.drawString(container.getAddress().getName(), guiLeft + 19, guiTop + 22,
				fontColor.get("gui.mail.text"));
	}
}
