...
public class SimpleIndividualRoot<I extends IIndividual> extends IndividualRoot<I> {
	...
	public I create(CompoundNBT compound) {
		try {
			...
			throw new IllegalStateException("The individual class of the root with the uid '" + uid + "' doesn't has default constructor with the following parameter types (CompoundNBT). " + "Please create a constructor for these types or implement the create(CompoundNBT) method of the root.", e);
	...
	public I create(IGenome genome) {
		try {
			...
			throw new IllegalStateException("The individual class of the root with the uid '" + uid + "' doesn't has default constructor with the following parameter types (IGenome). " + "Please create a constructor for these types or implement the create(IGenome) method of the root.", e);
		} catch (InstantiationException | IllegalAccessException | InvocationTargetException e) {
			throw new IllegalStateException("Failed to instantiate an instance of the individual class of the root with the uid '" + uid + "'.", e);
		}
	}
	...
	public I create(IGenome genome, IGenome mate) {
		try {
			...
			throw new IllegalStateException("The individual class of the root with the uid '" + uid + "' doesn't has default constructor with the following parameter types (IGenome,IGenome). " + "Please create a constructor for these types or implement the create(IGenome,IGenome) method of the root.", e);
		} catch (InstantiationException | IllegalAccessException | InvocationTargetException e) {
			throw new IllegalStateException("Failed to instantiate an instance of the individual class of the root with the uid '" + uid + "'.", e);
		}
	}
